...
int gNumberOfPoints = 0;
int gNumberOfAffinePoints = 0;
...
int maint(int argc, char **argv)
{
   if (argc>1)
   {
      ...
      double t1 = 0;
      {
         ...
         t1 = getTime(); gNumberOfPoints = 0;
         detector.detectPyramidKeypoints(image);
         cout << "Detected " << gNumberOfPoints << " keypoints and " << gNumberOfAffinePoints << " affine shapes in " << getTime()-t1 << " sec." << endl;
